                ...
                <div className='flex flex-col gap-8'>
                    ...
                    <form action="" id='create-form' className='flex flex-col gap-6 '>
                        <div className='relative'>
                            ...
                            <input onChange={handleChange} value={formData.fullname} className='border px-4 py-2 w-full rounded-md' type="text" name="fullname" id="fullname" required placeholder='John' />
                        </div>
                        <div className='relative'>
                            ...
                            <input onChange={handleChange} value={formData.phno} className='border px-4 py-2 w-full rounded-md' type="tel" name="phno" id="phno" required placeholder='Doe' />
                        </div>
                        <div className='relative'>
                        ...
                        <div className='relative'>
                            ...
                            <input onChange={handleChange} value={formData.company} className='border px-4 py-2 w-full rounded-md' type="text" name="company" id="company" required placeholder='Google' />
                        </div>
